...
@section('content')
    ...
    <main class="offset-md-3 offset-lg-2 col-12 ms-sm-auto px-md-4 py-4" style="height:100vh; overflow-y:auto;">
        ...
        @endif
        <h3 class="fw-normal pb-3" style=" color: #3b82f6;">Pending Payment List - Cafe Pixel</h3>
                            ...
                            >
                                ...
                                @if(auth()->user()->getrole() == "admin" || auth()->user()->getrole() == "cashier")
                                    <td>
                                        ...
                                        <a href="{{ route('pay.paid', $o->id) }}" class="text-success me-2" title="Confirm Payment">
                                            <i class="bi bi-cash-coin fs-5"></i>
                                        </a>

                                        <!-- Delete Button -->
                                        <form action="{{ route('order.delete', $o->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this order?');">
                                            @csrf
                                            <button type="submit" class="btn btn-link p-0 text-danger" title="Delete Order">
